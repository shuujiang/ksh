! function(e, t) {
	...
	return function(e) {
		...
		function s(e, t, i, n, s) {
			e.pattern instanceof RegExp && (console.log(t, e.pattern, e.pattern.test(t)), e.pattern.test(t) || n.push(a.format(s.messages.pattern.mismatch, e.fullField, t, e.pattern)))
		}
		Object.defineProperty(t, "__esModule", {
			value: !0
		});
				...
				var t = function(t, n) {
					...
					i = function(t, i, n) {
						i.domVisible || "none" === (0, a.getStyle)(i, "display") || "hidden" === (0, a.getStyle)(i, "visibility") || (Object.keys(i.maskStyle).forEach(function(e) {
							...
							n.modifiers.fullscreen && n.modifiers.lock && (t.style.overflow = "hidden"), i.domVisible = !0, t.appendChild(i.mask), e.nextTick(function() {
